...
str(mtcars)
# The commented code below will not work since R stores numerics as doubles 
# even though R displays numerics as decimals or integers.
# We need a way to store doubles as decimals in the database. Row name by default.
